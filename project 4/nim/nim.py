...
class NimAI():
    ...
    def update_q_value(self, state, action, old_q, reward, future_rewards):
        """
        Update the Q-value for the state and action
    ...
    def best_future_reward(self, state):
        """
        Return the best possible Q-value for the given state.
        If no actions are found in Q-table, return 0.
        """
    ...
    def choose_action(self, state, epsilon=True):
        ...
        - With probability self.epsilon, choose randomly.
